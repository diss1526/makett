// alert('Dear, Friends! I wish u a happy merry christmas, wishing u good health and success, may your dreams come true. ')
...
// Canvas animation with snowfall effect
...
window.addEventListener("scroll", () => {
  if(window.scrollY > 0) {
    ...
    newHeader.style.transition = "1s all";
  } else {
